...
export PYTHONPATH
PYTHONPATH="${DATACENTER_DIR}"/project/src
...
python "${DATACENTER_DIR}/project/src/com/maxmin/aws/startup.py" "${DATACENTER_DIR}/config/datacenter.json" "${DATACENTER_DIR}/config/hostedzone.json" 
